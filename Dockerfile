...
RUN apt-get install fonts-font-awesome wget
RUN mkdir fonts
...
#RUN wget 'https://github.com/google/fonts/raw/main/ofl/montserrat/Montserrat%5Bwght%5D.ttf' -q -O fonts/Montserrat-Regular.ttf
RUN wget 'https://github.com/google/fonts/raw/ca9288e18a30b8112cc9665371711c1cba5fd942/ofl/montserrat/Montserrat-Regular.ttf' -q -O fonts/Montserrat-Regular.ttf
